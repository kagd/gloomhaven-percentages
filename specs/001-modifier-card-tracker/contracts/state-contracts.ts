// State Contracts: TypeScript interfaces for application state
...
export interface StateActions {
  initializeDecks: (playerCards: Record<CardTypeName, number>, monsterCards: Record<CardTypeName, number>) => void;
